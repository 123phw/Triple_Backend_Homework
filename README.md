...
|---|---|---|---|---|---|
|리뷰 이벤트 생성 및 포인트 적립|POST|/event|"type": "REVIEW",
"action": "ADD",
...
Not Found(404): 해당하는 리소스가 없는 경우|
|포인트 정보|GET|/{userId}|---|---|OK(200): 성공

Unauthorized(401) : 헤더에 token이 없을 경우

Not Found(404):  token의 UID에 해당하는 리소스가 없는 경우|
